...
/** Generated Process for (groovy:R_Horas_HEAD_400 Calculo X Horas  en Asueto diurno HEAD 400)
 *  Description: 400%
 *  @author ADempiere (generated) 
 *  @version Release 3.9.4
 */
public class groovy_R_Horas_HEAD_400 implements RuleInterface {
	...
	public Object run(MHRProcess process, Map<String, Object> engineContext) {
		...
		double c_he_o = process.getConcept("O_Horas_HEAD_400");
