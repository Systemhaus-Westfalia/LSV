...
/** Generated Process for (groovy:R_Horas_HEAN_500 Calculo X Horas  en Asueto diurno HEAN 500)
 *  Description: 500%
 *  @author ADempiere (generated) 
 *  @version Release 3.9.4
 */
public class groovy_R_Horas_HEAN_500 implements RuleInterface {
	...
	public Object run(MHRProcess process, Map<String, Object> engineContext) {
		...
		double c_he_o = process.getConcept("O_Horas_HEAN_500");
