...
/** Generated Process for (groovy:Horas_JornadaAsueto Horas Extras Horas_JornadaAsueto)
 *  Description: Normale Ueberstunden 
 *  Help: O_Pago_DD_100
 *  @author ADempiere (generated) 
 *  @version Release 3.9.4
 */
public class groovy_Horas_JornadaAsueto implements RuleInterface {
	...
	public Object run(MHRProcess process, Map<String, Object> engineContext) {
		...
		description = null;
				...
				double c_he_o = process.getConcept("O_Horas_JornadaAsueto");
