...
/** Generated Process for (groovy:R_Hora_N_25 Calculo X Horas  Hora Extra Nocturnidad)
 *  Description: 25%
 *  @author ADempiere (generated) 
 *  @version Release 3.9.4
 */
public class groovy_R_Hora_N_25 implements RuleInterface {
	...
	public Object run(MHRProcess process, Map<String, Object> engineContext) {
		...
		double c_he_o = process.getConcept("O_Hora_N_25");
