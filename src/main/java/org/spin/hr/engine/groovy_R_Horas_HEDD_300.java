...
/** Generated Process for (groovy:R_Horas_HEDD_300 Calculo X Horas  Hora Extra Descanso diurno HEDD_300)
 *  Description: 300%
 *  @author ADempiere (generated) 
 *  @version Release 3.9.4
 */
public class groovy_R_Horas_HEDD_300 implements RuleInterface {
	...
	public Object run(MHRProcess process, Map<String, Object> engineContext) {
		...
		double c_he_o = process.getConcept("O_Horas_HEDD_300");
