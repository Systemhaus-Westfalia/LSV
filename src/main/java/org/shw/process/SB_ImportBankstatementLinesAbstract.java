 ...
 */
public abstract class SB_ImportBankstatementLinesAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SB_ImportBankstatementLines";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "SB_ImportBankstatementLines";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54922;
