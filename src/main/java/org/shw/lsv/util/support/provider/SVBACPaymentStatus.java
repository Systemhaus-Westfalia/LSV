...
public class SVBACPaymentStatus implements IDeclarationProvider {
		...
		else if (response.getStatus() ==200 ) 
		{
	        ...
	        try {
	            ...
	            if (documentNode.has("CstmrPmtStsRpt")) {
	                ...
	                collectSuccessSummary(rootNode, payment);
	...
	private  String collectResponseSummary(CAMT052Response response, StringBuffer log, MBankAccount bankAccount) {
	...
	private  void collectSuccessSummary(JsonNode rootNode, MPayment payment) {
       // summary.append("********************************************\n");
      ...
      //  summary.append("To-BICFI: ").append(getRequiredText(rootNode, "File", "Envelope", "AppHdr", "To", "FIId", "FinInstnId", "BICFI")).append("\n");
       ...
       // summary.append("\n");
		String status = getRequiredText(rootNode, "File", "Envelope", "Document", "CstmrPmtStsRpt", "OrgnlPmtInfAndSts", "PmtInfSts");
		String reason = getRequiredText(rootNode, "File", "Envelope", "Document", "CstmrPmtStsRpt", "OrgnlPmtInfAndSts", "StsRsnInf", "AddtlInf");
		payment.set_ValueOfColumn("evtCd", status);
		payment.set_ValueOfColumn("EvtDesc", reason);
        ...
        String transactionStatus = getRequiredText(firstTx, "StsId");
        String transactionStatusReason = getRequiredText(firstTx, "StsRsnInf", "AddtlInf");
        payment.set_ValueOfColumn("transactionStatusReason", transactionStatusReason);
        payment.saveEx();
    }

    private  void collectRejectionSummary(JsonNode documentNode, StringBuffer summary) {
        summary.append("********************************************\n");
    ...
    private  void collectErrorSummary(JsonNode rootNode, StringBuffer summary) {
        summary.append("********************************************\n");
    ...
    private  String getRequiredText(JsonNode node, String... path) {
