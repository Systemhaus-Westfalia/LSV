...
public class SVBAC_RequestPayment extends SVBAC_RequestPaymentAbstract
{
	...
	protected String doIt() throws Exception
	{
		...
		System.out.println("\n" + "******************************************************");
		System.out.println("Process Banking Payment request: started with Client");
		...
		try {
			...
			else if (transfertype.equals(EBankingConstants.TRANSFERINT))
				svbacPaymentBAC.sendPaymentRequestBACtoInt();
		} catch (Exception e) {
